				...
				<nav className="navbar navbar-header navbar-expand-xl fixed-top">
					...
					<div id="navbarToggle" className="collapse navbar-collapse">
						<div className="search-container mx-auto">
							<input type="text" ref="search" placeholder="Search..." className="search-input" onInput={this.updateTextInput} onKeyPress={this.handleKeyPress} />
							<button className="search-button" type="button" onClick={this.searchForArtifacts}>Search</button>
						</div>
						<div className="user-container">
							<Link to="/login"><button type="button" className="login-button btn btn-outline-dar">Login</button></Link>
						</div>
					</div>
