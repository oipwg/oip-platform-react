			...
			<div>
				...
				<div className="container-fluid">
					...
					<div className="row" style={{height: "100px", overflowY: "hidden"}}>	
						<div className="col-12 col-sm-12 col-md-6 col-lg-5 col-xl-4" style={{height: "100px", padding: "20px"}}>
						...
						<div className="col-12 col-sm-12 col-md-6 col-lg-7 col-xl-8" style={{padding: "20px"}}>
